...
CK:V2.07i | S:A | PH:V2 | PR:P2 | EF:M | AR:OPS | IN: implement operations dashboard reporting for maintenance, db health, schema versions, file sizes, write mode, export/backup freshness, benchmark baselines | DOD:[ops_snapshot_api, alert_thresholds, cli_json, docs/tests] | DEP:[doctor,status,V2.07d] | RSK:[local_env_variance] | NXT:[client.buildOperationsDashboardSnapshot + CLI dashboard operations complete for backend/schema/db_size/maintenance_due/backup/doctor_status; richer thresholds and benchmark baseline panel remain]
