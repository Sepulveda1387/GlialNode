...
CK:V2.07s | S:D | PH:V2 | PR:P2 | EF:S | AR:REL | IN: define OSS vs paid dashboard boundary before Supabase/Postgres/team dashboard work | DOD:[boundary_doc, oss_local_metrics_scope, paid_team_auth_billing_scope, roadmap_alignment] | DEP:[V2.01,V2.07] | RSK:[open_source_confusion_or_premature_saas_scope] | NXT:[completed: exported dashboard distribution boundary helpers reserve hosted_team_dashboard, supabase_project_backend, postgres_team_storage, subscription_billing, org_role_access_control, and cross_user_tenancy outside OSS while documenting allowed local metrics/json/html/http/demo capabilities]
